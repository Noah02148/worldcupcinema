...
(function () {
  ...
  const DEFAULT_STRINGS = {
    ...
    parlay_title:    { zh: 'Claude AI 过关方案', en: 'Claude AI Parlay pick' },
    parlay_info:     { zh: '此过关方案由 Claude AI 最新模型 Fable 5 推荐,仅供参考。', en: 'These picks are recommended by Claude AI’s latest model, Fable 5 — for reference only.' },
