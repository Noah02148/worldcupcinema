...
(function () {
  ...
  const DEFAULT_STRINGS = {
    ...
    parlay_title:    { zh: 'Claude AI 预测方案', en: 'Claude AI prediction' },
    parlay_info:     { zh: '此预测方案由 Claude AI 模型(Fable 5)生成,仅供娱乐。', en: 'This prediction is generated by a Claude AI model (Fable 5) — for entertainment only.' },
